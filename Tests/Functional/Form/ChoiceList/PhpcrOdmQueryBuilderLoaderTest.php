...
class PhpcrOdmQueryBuilderLoaderTest extends BaseTestCase
{
    ...
    {
        $qb = $this->dm->getRepository('Doctrine\Bundle\PHPCRBundle\Tests\Fixtures\App\Document\TestDocument')->createQueryBuilder('e');
        ...
        foreach ($documents as $i => $document) {
            $this->assertInstanceOf('Doctrine\Bundle\PHPCRBundle\Tests\Fixtures\App\Document\TestDocument', $document);
